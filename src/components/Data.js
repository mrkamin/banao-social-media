...
const Data = [
  ...
  },
  {
    ...
    visit: <button type="button" className="btn btn-light w-100">Visit Site</button>,
    userimage: IMG6,
  ...
  },
  {
    ...
    visit: <button type="button" className="btn btn-light w-100">Apply on TimesJobs</button>,
    userimage: IMG7,
